        ...
        <aside class="admin-sidebar">
            <nav>
                <ul>
                    ...
                    <li><a href="/admin/proyectos/index.php" class="<?= strpos($_SERVER['PHP_SELF'], '/proyectos/') !== false ? 'active' : '' ?>"><svg class="admin-icon" width="16" height="16" aria-hidden="true"><use xlink:href="#icon-list"/></svg> Clases</a></li>
                    <li><a href="/admin/materiales/index.php" class="<?= strpos($_SERVER['PHP_SELF'], '/materiales/') !== false ? 'active' : '' ?>"><svg class="admin-icon" width="16" height="16" aria-hidden="true"><use xlink:href="#icon-flask"/></svg> Componentes</a></li>
