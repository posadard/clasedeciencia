    ...
    <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
      ...
      <table border="0" width="100%">
        <tr>
          ...
          <td>
             <P><font size="2" face="Verdana">Intermediate projects are best for
             students in seven and eight grades. However higher grade students
             may also find these projects to be interesting and educational.</font></P>
             <P><font size="2" face="Verdana">(For ages 13 to 15)</font></P>
        <%
        Set rs=Server.CreateObject("ADODB.Recordset")
        str="Select * from projectinfo where id like'I%' and completed=1 order by id"
        rs.open str, conn
        While NOT rs.EOF
            title=rs("title")
            id=rs("id")
            response.write id &"   "&"<A HREF=/projects/intro/intermediate/"&id&".asp?t="&time()&">"& title &"</A><BR>"
            rs.MoveNext
