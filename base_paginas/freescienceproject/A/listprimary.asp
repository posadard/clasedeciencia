    ...
    <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
      ...
      <table border="0" width="100%">
        <tr>
          ...
          <td>
             <P><font size="2" face="Verdana">Primary projects are best for
             students in first to fourth grades. However higher grade students
             may also find these projects to be interesting and educational.</font></P>
             <P><font size="2" face="Verdana">(For ages 6 to 10)</font></P>
        <%
        Set rs=Server.CreateObject("ADODB.Recordset")
        str="Select * from projectinfo where id like'P%' and completed=1 order by id"
        rs.open str, conn
        While NOT rs.EOF
            title=rs("title")
            id=rs("id")
            response.write id &"   "&"<A HREF=/projects/intro/primary/"&id&".asp?t="&time()&">"& title &"</A><BR>"
            rs.MoveNext
...
<TABLE WIDTH="600" BORDER="0" CELLSPACING="0" CELLPADDING="2">
  <TR>
    ...
    hazard,<br>
    author and publisher expressly disclaim all liabilities for any occurrence,
    including, but<br>
    not limited to, damage, injury or death which might arise as a consequence of<br>
    the use of any information/experiments listed or described here. Therefore, you assume
    all liabilities and use such information at your own risk!</font></b>
    </TD>
  </TR>
</TABLE>
