    ...
    <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
      ...
      <table border="0" width="100%">
        <tr>
          ...
          <td>
             <P><font size="2" face="Verdana">Elementary projects are best for
             students in fifth to eight grades. However higher grade students
             may also find these projects to be interesting and educational.</font></P>
             <P><font size="2" face="Verdana">(For ages 10 to 14)</font></P>
        <%
        Set rs=Server.CreateObject("ADODB.Recordset")
        str="Select * from projectinfo where id like'E%' and completed=1 order by id"
        rs.open str, conn
        While NOT rs.EOF
            title=rs("title")
            id=rs("id")
            response.write id &"   "&"<A HREF=/projects/intro/elementary/"&id&".asp?t="&time()&">"& title &"</A><BR>"
            rs.MoveNext
